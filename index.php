...
coalesce((SELECT bid_amount FROM bid WHERE lot_id=L.id ORDER BY bid_date DESC LIMIT 1),
L.start_price) price FROM lot L JOIN category C ON L.category_id = C.id
WHERE expiration_date >= CURRENT_TIMESTAMP ORDER BY creation_date DESC  LIMIT 9";
